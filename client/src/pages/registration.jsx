    ...
    return (
        <div>
            <nav className='flex h-30'>
                ...
                <Button variant="ghost" className="hover:bg-transparent hover:text-white text-gray-300 absolute right-10 top-10" onClick={()=>navigate('/landingpage')}><MoveLeft className='w-10 text-green-400'/> Go back</Button>
            ...
            <div className='flex justify-between w-full p-20 flex-wrap space-y-8 '>
                <div className='shadow-[0_0_3px] hover:shadow-[0_0_30px] hover:shadow-green-600 group hover:scale-105 transition-all ease-in-out duration-300 rounded-lg p-5 space-y-3 flex flex-col items-center max-w-90'>
                ...
                <div className='shadow-[0_0_3px] hover:shadow-[0_0_30px] hover:shadow-teal-600 group hover:scale-105 transition-all ease-in-out duration-300 rounded-lg p-5 space-y-3 flex flex-col items-center max-w-90'>
                    ...
                    <Button className="shadow-none hover:scale-105 ease-in-out duration-200">Register for Hackathon</Button>
                </div>
                <div className='shadow-[0_0_3px] hover:shadow-[0_0_30px] hover:shadow-emerald-600 group hover:scale-105 transition-all ease-in-out duration-300 rounded-lg p-5 space-y-3 mb-[32px] flex flex-col items-center max-w-90'>
                    <Palette className=' bg-emerald-600 h-12 rounded-lg w-12 p-2' />
                    <h1 className='text-xl font-bold text-gray-300 group-hover:text-gray-200'>Graphic Designing</h1>
